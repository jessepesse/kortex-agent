---
description: Create professional GitHub releases with comprehensive release notes using gh CLI
---
...
1. Does this introduce breaking changes? → Major bump
2. Are there significant new features? → Minor bump
3. Is it primarily bug fixes? → Patch bump
